...
struct Map_
{
  ...
  _ids_type ids;
  using _poses_type =
    std::vector<geometry_msgs::msg::PoseWithCovariance_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<geometry_msgs::msg::PoseWithCovariance_<ContainerAllocator>>>;
  _poses_type poses;
  ...
  Type & set__poses(
    const std::vector<geometry_msgs::msg::PoseWithCovariance_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<geometry_msgs::msg::PoseWithCovariance_<ContainerAllocator>>> & _arg)
  {
    this->poses = _arg;
    return *this;
  }
