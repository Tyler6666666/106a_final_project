...
struct Observations_
{
  ...
  using _observations_type =
    std::vector<fiducial_vlam_msgs::msg::Observation_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<fiducial_vlam_msgs::msg::Observation_<ContainerAllocator>>>;
  ...
  Type & set__observations(
    const std::vector<fiducial_vlam_msgs::msg::Observation_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<fiducial_vlam_msgs::msg::Observation_<ContainerAllocator>>> & _arg)
  {
