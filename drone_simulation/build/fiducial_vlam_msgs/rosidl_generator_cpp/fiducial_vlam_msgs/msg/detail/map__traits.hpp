  ...
  std::ostream & out)
{
  ...
  // member: fixed_flags
  {
    if (msg.fixed_flags.size() == 0) {
      out << "fixed_flags: []";
    } else {
      out << "fixed_flags: [";
      size_t pending_items = msg.fixed_flags.size();
      for (auto item : msg.fixed_flags) {
...
inline void to_yaml(
  const fiducial_vlam_msgs::msg::Map & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const fiducial_vlam_msgs::msg::Map & msg)
{
