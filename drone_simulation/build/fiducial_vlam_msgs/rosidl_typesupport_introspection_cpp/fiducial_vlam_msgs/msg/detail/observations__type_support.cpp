...
void fetch_function__Observations__observations(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const fiducial_vlam_msgs::msg::Observation *>(
    get_const_function__Observations__observations(untyped_member, index));
  auto & value = *reinterpret_cast<fiducial_vlam_msgs::msg::Observation *>(untyped_value);
  value = item;
}

void assign_function__Observations__observations(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<fiducial_vlam_msgs::msg::Observation *>(
    get_function__Observations__observations(untyped_member, index));
  const auto & value = *reinterpret_cast<const fiducial_vlam_msgs::msg::Observation *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Observations_message_member_array[3] = {
  ...
  },
  {
    ...
    fetch_function__Observations__observations,  // fetch(index, &value) function pointer
    assign_function__Observations__observations,  // assign(index, value) function pointer
